...
const Data = () => {
  return (
    <div className='home_data'>
      ...
      <p className="home_description">I'm Yeasin Shakil, an enthusiastic self-taught fresher-level Frontend developer.  I have been learning web development based on YouTube and other websites through my efforts for last one year. Currently. I have learned programming languages  Javascript, and Typescript and based on them front-end technologies like React JS and Next JS, and back-end technology Node JS, ExpressJS,  and Mongo DB as a database. Additionally, I am contributing to an open-source UI library called ZenUI that will be launched on Product Hunt very soon.</p>
