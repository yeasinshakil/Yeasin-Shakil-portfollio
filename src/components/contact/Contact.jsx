...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_hmv8aob', 'template_fu9ntg6', form.current, '3D6iibSTlm9eNNDQW')
      .then((result) => {
    ...
    return (
        <section className="contact section" id="contact">
            ...
            <div className="contact_container container grid">
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">shakilrock1998@gmail.com</span>

                            <a href="shakilrock1998@gmail.com" className="contact_button">Write me{" "} <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                        </div>
                ...
                <div className="contact_content">
                    <h3 className="contact_title">Write to me your project</h3>
                    <form ref={form} onSubmit={sendEmail} className="contact_form">
                        ...
                        <div className="contact_fomr-div contact_form_area">
